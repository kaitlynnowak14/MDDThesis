# ============================================================================
# Title: PGRN-AMPS Visualization & Figure Generation
# Dataset: PGRN-AMPS Cohort
#
# Description:
#   - Generate publication-quality thesis figures
#   - Visualize SES, sex, and PRS associations with age of onset
#   - Plot nested model R² progression for EA and MA PRS models
#
# Output:
#   ggplot2 visualizations for manuscript/thesis figures
#
# Notes:
#   - Uses thesis-specific theme formatting
#   - EA PRS displayed as black solid line
#   - MA PRS displayed as blue dashed line
# ============================================================================

# =====================================================
# 1. LOAD PACKAGES & SET THEME
# =====================================================
...
# =====================================================
# 2. UNIVARIATE UNADJUSTED FIGURES
# =====================================================

# ---- SES and Age of Onset ----
# Define axis limits
y_age_lim <- c(0, 89)

# Fit SES regression model
...
# =====================================================
# 3. NESTED MODEL VISUALIZATION
# =====================================================

# ---- R^2 Progression Plot ----
# Create R^2 summary table 
model_r2 <- data.frame(
